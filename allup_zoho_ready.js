...
//    |
//    +-- SUCCESS + refund --> Zoho Credit Note
//
// GROUPING
// --------
...
for each  groupKey in chargeGroups.keys()
{
	...
	for each  txn in groupTransactions
	{
		...
		lineItem.put("description",orderTypeLabel + " | AllUp Transaction: " + transactionId + " | Member: " + customerId);
...
// ============================================================================
// 4. PROCESS REFUNDS -> CREDIT NOTES
// ============================================================================
for each  groupKey in refundGroups.keys()
{
	...
	// ========================================================================
	// CREATE ONE CREDIT NOTE PER REFUND (duplicate-checked)
	// ========================================================================
	for each  refundTxn in refundTransactions
	{
		...
		creditNoteLine.put("description",orderTypeLabel + " | AllUp Refund: " + transactionId + " | Original Invoice: " + originalInvoice);
		...
		if(creditNoteResponse != null && creditNoteResponse.get("creditnote") != null)
		{
			...
			info "Credit Note ID: " + createdCreditNote.get("creditnote_id");
		}
		else
		{
